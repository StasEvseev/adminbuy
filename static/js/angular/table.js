...
.factory("load", function() {
    return {
        loadData: function (func, restapi_func, params, scope) {
            ...
            attrIfDef('filter_field', filter_field, param);
            attrIfDef('filter_text', filter_text, param);
            attrIfDef('sort_field', sort_field, param);
            attrIfDef('sort_course', sort_course, param);
            attrIfDef('page', page, param);
            attrIfDef('count', count, param);

            restapi_func(param, func);
        }
    }
})
