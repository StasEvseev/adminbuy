...
.config(function($routeProvider, $locationProvider) {
        var staticPath = '/static/acceptance/template/';
  $routeProvider
      .when('/admin/acceptanceview', {
          templateUrl: staticPath + 'acceptance_main.html',
          controller: 'AcceptanceMainCtrl',
          label: 'Список приемок'
      })
      .when('/admin/acceptanceview/:id/edit', {
          templateUrl: staticPath + 'acceptance_edit.html',
