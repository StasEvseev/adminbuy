...
from adminbuy.applications.waybill.models import (WayBill, RETAIL, GROSS,
                                                  POINTSALE, RECEIVER, IN_PROG,
                                                  IN_DELIVERY, FINISH)
...
from ..helpers.suits.receiver import ReceiverSuite
from ..helpers.suits.waybill import WayBillTestSuite
