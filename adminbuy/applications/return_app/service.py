...
from adminbuy.applications.good.service import GoodArgumentExc
from adminbuy.services.core import BaseSQLAlchemyModelService

from .model import Return, ReturnItem, StatusType
...
class ReturnService(BaseSQLAlchemyModelService):
    ...
    def create_return(cls, date_start, date_end, provider_id):
        order = Return(date_start=date_start, date_end=date_end,
