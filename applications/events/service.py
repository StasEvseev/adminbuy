...
class EventService(BaseSQLAlchemyModelService):
    ...
    @classmethod
    def create_event(cls, user_id, datetime, type=model.MAIL, title_from='', title='', body='', foot=''):
        data = {
        ...
        return cls.create_instance(type=type, datetime=datetime, user_id=user_id, date=json.dumps(data))
